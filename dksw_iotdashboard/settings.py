"""
Django settings for dksw_iotdashboard project.
...
SECRET_KEY = 'django-insecure-8h3k!(c7y^ix^59zjrz#76=g-6002l*ke5k)x-h(xbg&50(m1i'
...
ROOT_URLCONF = 'dksw_iotdashboard.urls'
...
WSGI_APPLICATION = 'dksw_iotdashboard.wsgi.application'
